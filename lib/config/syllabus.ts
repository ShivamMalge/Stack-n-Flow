    ...
    modules: [
        ...
        },
        {
            ...
            topics: [
                ...
                { title: "Queues using dynamic arrays", visualizer: "queue", coverage: "partial", note: "The visualizer grows without bound; it never shows the doubling-and-copy step that is the point of the topic." },
