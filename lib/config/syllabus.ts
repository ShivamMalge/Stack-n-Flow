    ...
    modules: [
        ...
        },
        {
            ...
            topics: [
                ...
                { title: "Single-ended priority queues", visualizer: "priority-queue", coverage: "full", note: "Min- and max-heap as the ADT: insert by priority, extract the highest, and a refusal with a reason when the other end is asked for." },
                { title: "Double-ended priority queues", visualizer: "priority-queue", coverage: "full", note: "Min-max heap with the alternating min and max levels drawn as bands, and both ends extractable in O(log n)." },
